...
@class YDImportCustModel;
@interface YDIntentionCustomerFMDB : NSObject

SINGLE_INTERFACE(YDIntentionCustomerFMDB)

/**
 *  插入导入的意向客户模型
 *
 *  @param importCustModel 导入的意向客户模型
 */
