...
{
    //灰色背景
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, ScreenHeight)];
    bgView.backgroundColor = [UIColor blackColor];
    bgView.alpha = 0.5f;
    [self addSubview:bgView];
    
    // 弹出的整个视图
    _wholeView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, 240)];
    _wholeView.backgroundColor = [UIColor clearColor];
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++)
    {
        ...
        [button setTitleColor:[UIColor colorWithRed:0 green:130 blue:253] forState:UIControlStateNormal];
    ...
    _pickerView.backgroundColor = kViewControllerBackgroundColor;
...
- (void)showBottomView
{
    ...
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight-240.0f, ScreenWidth, 240.0f);
...
- (void)hiddenBottomView
{
    [UIView animateWithDuration:0.3 animations:^
    {
        _wholeView.frame = CGRectMake(0, ScreenHeight, ScreenWidth, 240.0f);
